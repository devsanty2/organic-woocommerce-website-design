...
$sidebar_configs = oworganic_get_woocommerce_layout_configs();
?>

<?php do_action( 'oworganic_woo_template_main_before' ); ?>

<section id="main-container" class="main-content <?php echo apply_filters('oworganic_woocommerce_content_class', 'container');?>">
