...
?>
<div class="product-block grid grid-v2 grid-v4" data-product-id="<?php echo esc_attr($product_id); ?>">
    <div class="grid-inner">
        <div class="block-inner">
            ...
            <div class="wishlist-compare-wrapper">
                ...
                <?php } elseif( oworganic_is_woosc_activated() && get_option('_woosc_button_archive') == "0" ) {?>
