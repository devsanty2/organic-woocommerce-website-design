...
<ul class="shop_table cart wishlist_table wishlist_view responsive mobile <?php echo esc_attr($show_cb ? 'with-checkbox' : ''); ?>" data-pagination="<?php echo esc_attr( $pagination )?>" data-per-page="<?php echo esc_attr( $per_page )?>" data-page="<?php echo esc_attr( $current_page )?>" data-id="<?php echo esc_attr($wishlist_id); ?>" data-token="<?php echo esc_attr($wishlist_token); ?>">
    ...
    if( $wishlist && $wishlist->has_items() ) :
                                ...
                                <?php if( $show_variation || $show_dateadded || $show_price ): ?>
                                    <table class="item-details-table">
    	                                ...
    	                                <?php if( $show_dateadded && $item->get_date_added() ): ?>
                                            <tr>
                                                <td class="label">
                                                    <?php esc_html_e( 'Added on:', 'oworganic' ) ?>
                                                </td>
                                                <td class="value">
                                                    <?php echo trim($item->get_date_added_formatted()); ?>
                                                </td>
                                            </tr>
    	                                <?php endif; ?>
    	                                ...
    	                                <?php if( $show_price || $show_price_variations ) : ?>
                                            <tr>
                                                <td class="label">
                                                    <?php esc_html_e( 'Price:', 'oworganic' ) ?>
                                                </td>
                                                <td class="value">
                                                    <?php
                                                    if( $show_price ) {
                            ...
                            <div class="additional-info-wrapper">
                                <?php if( $show_quantity || $show_stock_status ): ?>
                                    <table class="additional-info">
                                        <?php if( $show_quantity ) : ?>
                                            <tr>
                                                <td class="label">
                                                    <?php esc_html_e( 'Quantity:', 'oworganic' ) ?>
                                                </td>
                                                <td class="value">
                                        ...
                                        <?php if( $show_stock_status ) : ?>
                                            <tr>
                                                <td class="label">
                                                    <?php esc_html_e( 'Stock:', 'oworganic' ) ?>
                                                </td>
                                                <td class="value">
                                                    <?php echo trim($stock_status == 'out-of-stock' ? '<span class="wishlist-out-of-stock">' . esc_html__( 'Out of stock', 'oworganic' ) . '</span>' : '<span class="wishlist-in-stock">' . esc_html__( 'In Stock', 'oworganic' ) . '</span>'); ?>
                                                </td>
                                            </tr>
                                        <?php endif ?>
                                    </table>
                                    ...
                                    <div class="move-to-another-wishlist">
                                        <?php if( 'select' == $move_to_another_wishlist_type ): ?>
                                            <select class="change-wishlist selectBox">
                                                <option value=""><?php esc_html_e( 'Move', 'oworganic' ) ?></option>
                                                <?php
                                        ...
                                        <?php else: ?>
                                            <a href="#move_to_another_wishlist" class="move-to-another-wishlist-button" data-rel="prettyPhoto[move_to_another_wishlist]">
                                                <?php echo apply_filters( 'yith_wcwl_move_to_another_list_label', esc_html__( 'Move to another list &rsaquo;', 'oworganic' ) ) ?>
                                            </a>
                                        <?php endif; ?>
                                    </div>
                                <?php endif; ?>
                                ...
                                <?php if( $show_remove_product ): ?>
                                    <div class="product-remove">
                                            <a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item->get_product_id() ) ) ?>" class="remove_from_wishlist" title="<?php echo apply_filters( 'yith_wcwl_remove_product_wishlist_message_title', esc_html__( 'Remove this product', 'oworganic' ) ); ?>"><i class="ti-close"></i></a>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
        ...
        <p class="wishlist-empty">
            <?php echo apply_filters( 'yith_wcwl_no_product_to_remove_message', esc_html__( 'No products added to the wishlist', 'oworganic' ) ) ?>
        </p>
    <?php
    endif;
