...
$carousel_type = (!empty($carousel_type)) ? $carousel_type : '';
...
<div class="slick-carousel products <?php echo esc_attr($slick_top.' '.$carousel_type); ?> <?php echo esc_attr( ($loop->post_count <= $columns)?'hidden-dots':'' ); ?>" <?php echo trim(!$elementor_element ? 'data-carousel="slick"' : ''); ?> 
