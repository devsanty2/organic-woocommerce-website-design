...
function oworganic_ocdi_import_files() {
    $demos = array();
    ...
    $demos[] = array(
        ...
        'local_import_redux'           => array(
            array(
                ...
                'option_name' => 'oworganic_theme_options',
            ),
        ),
        'import_preview_image_url'     => trailingslashit( get_template_directory_uri() ) . 'screenshot.png',
        'import_notice'                => esc_html__( 'Import process may take 5-10 minutes. If you facing any issues please contact our support.', 'oworganic' ),
        'preview_url'                  => 'http://demoapus2.com/oworganic/home/',
    );


    return apply_filters( 'oworganic_ocdi_files_args', $demos );
}
add_filter( 'pt-ocdi/import_files', 'oworganic_ocdi_import_files' );

function oworganic_ocdi_after_import_setup( $selected_import ) {
    ...
    if ( file_exists($file) ) {
        oworganic_ocdi_import_settings($file);
    }

    if ( oworganic_is_revslider_activated() ) {
        require_once( ABSPATH . 'wp-load.php' );
        require_once( ABSPATH . 'wp-includes/functions.php' );
        require_once( ABSPATH . 'wp-admin/includes/file.php' );

        $slider_array = array(
            trailingslashit( get_template_directory() ) . 'inc/vendors/one-click-demo-import/data/home-1.zip',
            trailingslashit( get_template_directory() ) . 'inc/vendors/one-click-demo-import/data/home-2.zip',
            trailingslashit( get_template_directory() ) . 'inc/vendors/one-click-demo-import/data/home-3.zip',
            trailingslashit( get_template_directory() ) . 'inc/vendors/one-click-demo-import/data/home-4-1.zip',
            trailingslashit( get_template_directory() ) . 'inc/vendors/one-click-demo-import/data/home-4.zip',
            trailingslashit( get_template_directory() ) . 'inc/vendors/one-click-demo-import/data/home-6.zip',
            trailingslashit( get_template_directory() ) . 'inc/vendors/one-click-demo-import/data/home-7.zip',
            trailingslashit( get_template_directory() ) . 'inc/vendors/one-click-demo-import/data/home-8.zip',
            trailingslashit( get_template_directory() ) . 'inc/vendors/one-click-demo-import/data/home-9.zip',
            trailingslashit( get_template_directory() ) . 'inc/vendors/one-click-demo-import/data/home-21.zip',
        );
...
add_action( 'pt-ocdi/after_import', 'oworganic_ocdi_after_import_setup' );

function oworganic_ocdi_import_settings($file) {
    ...
    if ( !empty($datas['page_options']) ) {
        oworganic_ocdi_import_page_options($datas['page_options']);
    }
    if ( !empty($datas['metadata']) ) {
        oworganic_ocdi_import_some_metadatas($datas['metadata']);
    }
}

function oworganic_ocdi_import_page_options($datas) {
    if ( $datas ) {
...
function oworganic_ocdi_import_some_metadatas($datas) {
    if ( $datas ) {
...
function oworganic_ocdi_before_widgets_import() {
...
add_action( 'pt-ocdi/before_widgets_import', 'oworganic_ocdi_before_widgets_import' );