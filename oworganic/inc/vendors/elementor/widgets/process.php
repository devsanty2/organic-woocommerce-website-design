...
class Oworganic_Elementor_Process extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Process', 'oworganic' );
    }
	...
	protected function register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                'name' => 'image',
                'label' => esc_html__( 'Icon Image', 'oworganic' ),
                'type' => Controls_Manager::MEDIA,
                'placeholder'   => esc_html__( 'Upload Icon Image', 'oworganic' ),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'input_type' => 'url',
                'placeholder' => esc_html__( 'Enter your proces link here', 'oworganic' ),
            ]
        );
        ...
        $this->add_control(
            'process',
            [
                'label' => esc_html__( 'Process', 'oworganic' ),
                'type' => Controls_Manager::REPEATER,
                'placeholder' => esc_html__( 'Enter your Process here', 'oworganic' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'input_type' => 'number',
                'placeholder' => esc_html__( 'Enter your column number here', 'oworganic' ),
                'default' => 4
            ]
        );
        $this->add_control(
            ...
            [
                'name' => 'image_line',
                'label' => esc_html__( 'Background Image Space Columns', 'oworganic' ),
                'type' => Controls_Manager::MEDIA,
                        ...
                        ?>
                                <div class="proces-item updow col-sm-6 col-md-<?php echo esc_attr($bcol); ?>">
                                    ...
                                    <?php if ( !empty($proces['list_title']) ) { ?>
                                        <h2 class="title"><?php echo trim($proces['list_title']); ?></h2>
                                    <?php } ?>
                                    <?php if ( !empty($proces['des']) ) { ?>
                                        <div class="des"><?php echo trim($proces['des']); ?></div>
                                    <?php } ?>
                                </div>
                        <?php } ?>
                    <?php } ?>
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Oworganic_Elementor_Process );
} else {
    Plugin::instance()->widgets_manager->register( new Oworganic_Elementor_Process );
}