...
class Oworganic_Elementor_Social_Links extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Apus Social Links', 'oworganic' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'social_icon_list',
            [
                'label' => esc_html__( 'Social Icons', 'oworganic' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => array(
                    ...
                    'st_ver' => esc_html__('Vertical', 'oworganic'),
                ),
                'default' => ''
            ]
        );
        ...
        $this->start_controls_section(
            'section_title_style',
            [
                'label' => esc_html__( 'Social', 'oworganic' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Oworganic_Elementor_Social_Links );
} else {
    Plugin::instance()->widgets_manager->register( new Oworganic_Elementor_Social_Links );
}