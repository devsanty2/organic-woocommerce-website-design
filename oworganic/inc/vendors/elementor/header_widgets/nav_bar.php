...
class Oworganic_Elementor_Nav_Bar extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Header NavBar', 'oworganic' );
    }
	...
	protected function register_controls() {
        ...
        $this->add_control(
            'icon_color',
            [
                'label' => esc_html__( 'Color Icon', 'oworganic' ),
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Oworganic_Elementor_Nav_Bar );
} else {
    Plugin::instance()->widgets_manager->register( new Oworganic_Elementor_Nav_Bar );
}