...
class Oworganic_Elementor_Woo_Category_Banner extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Product Category Banner', 'oworganic' );
    }
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'placeholder' => esc_html__( 'Enter your button text', 'oworganic' ),
                'default' => 'SHOP NOW',
            ]
        );
        ...
        $this->add_control(
            'show_nb_products',
            [
                'label' => esc_html__( 'Show Number Products', 'oworganic' ),
        ...
        $this->add_control(
            'show_subcategories',
            [
                'label' => esc_html__( 'Show SubCategories', 'oworganic' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => '',
                'label_on' => esc_html__( 'Hide', 'oworganic' ),
                'label_off' => esc_html__( 'Show', 'oworganic' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Number SubCategories', 'oworganic' ),
                'type' => Controls_Manager::NUMBER,
                'placeholder' => esc_html__( 'Enter number subcategories', 'oworganic' ),
                'default' => 5,
                'condition' => [
                    'style' => ['style1', 'style3'],
                ],
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Oworganic_Elementor_Woo_Category_Banner );
} else {
    Plugin::instance()->widgets_manager->register( new Oworganic_Elementor_Woo_Category_Banner );
}