...
class Oworganic_Widget_Woo_Layered_Nav extends WC_Widget {

	/**
	 * Constructor.
	 */
	public function __construct() {
		$this->widget_cssclass    = 'woocommerce widget_layered_nav apus-woocommerce-widget-layered-nav';
		$this->widget_description = esc_html__( 'Display a list of attributes to filter products in your store.', 'oworganic' );
		$this->widget_id          = 'apus_woocommerce_layered_nav';
		$this->widget_name        = esc_html__( 'Apus Filter Products by Attribute', 'oworganic' );
		parent::__construct();
	}
	...
	public function init_settings() {
		...
		$this->settings = array(
			...
			'attribute' => array(
				'type'    => 'select',
				'std'     => '',
				'label'   => esc_html__( 'Attribute', 'oworganic' ),
				'options' => $attribute_array,
			),
			'query_type' => array(
				'type'    => 'select',
				'std'     => 'and',
				'label'   => esc_html__( 'Query type', 'oworganic' ),
				'options' => array(
					'and' => esc_html__( 'AND', 'oworganic' ),
					'or'  => esc_html__( 'OR', 'oworganic' ),
				),
			),
		);
	}
	...
	protected function layered_nav_list( $terms, $taxonomy, $query_type ) {
		...
		echo '<ul class="woocommerce-widget-layered-nav-list apus-layered-nav-list">';
...
if ( function_exists('apus_framework_reg_widget') ) {
	apus_framework_reg_widget('Oworganic_Widget_Woo_Layered_Nav');
}