...
if ( 'left' === $layout ||  'right' === $layout ) {
    if( oworganic_get_config('product_archive_fullwidth') ) {
...
$display_mode = oworganic_woocommerce_get_display_mode();
...
?>
    <section id="main-container" class="page-shop margin-top-40 <?php echo apply_filters('oworganic_woocommerce_content_class', 'container');?>">
        <?php //do_action( 'woocommerce_before_main_content' ); ?>

        <div class="apus-dokan-store-wrap row">
                ...
                <div id="dokan-content" class="store-page-wrap woocommerce" role="main">
                    ...
                    <div id="apus-shop-products-wrapper" class="apus-shop-products-wrapper <?php echo esc_attr($layout_type); ?>" data-layout_type="<?php echo esc_attr($layout_type); ?>">
                        ...
                        <?php } else { ?>
                            ...
                            <p class="dokan-info"><?php esc_html_e( 'No products were found of this vendor!', 'oworganic' ); ?></p>
