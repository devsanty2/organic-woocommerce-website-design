        ...
        <div class="flex">
            ...
            <div class="inner-info">
                ...
                <?php if( !empty( get_the_excerpt() ) ){?>
                    <div class="description hidden-xs"><?php echo oworganic_substring( get_the_excerpt(), 35, '...' ); ?></div>
                <?php } ?>
                <?php if( !empty( get_the_excerpt() ) ){?>
                    <div class="description visible-xs"><?php echo oworganic_substring( get_the_excerpt(), 12, '...' ); ?></div>
                <?php } ?>
